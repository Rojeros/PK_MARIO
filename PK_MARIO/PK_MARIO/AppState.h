...
private:
	bool m_is_done;                                 // czy stan siê zakoñczy³ (i nale¿y przejœæ do nastêpnego)
	bool m_clear_before_draw;                       // czy przed rysowaniem stanu bêdzie czyszczenie ekranu
	bool m_swap_after_draw;                         // czy rysowanie zakoñczy siê podmian¹ buforów
};
